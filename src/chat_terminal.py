    ...
    async def login(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                console.print(f"[green]Logged in successfully as {self.user_id}[/green]")
                return True
            else:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                for i, mall in enumerate(self.malls, 1):
                    console.print(f"[cyan]{i}.[/cyan] {mall['name_en']} (ID: {mall['mall_id']})")
                return True
            else:
...
async def main():
    ...
    parser.add_argument("--api", help="API URL (default: http://localhost:8000)", default="http://localhost:8000")
